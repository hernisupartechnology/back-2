...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | APP_LOCALE=es y el proyecto no tenía ningún archivo de traducción, así
    | que todo mensaje de validación sin ->messages() propio se mostraba
    | como la clave sin traducir (ej: "validation.required"). Este archivo
    | resuelve eso para toda la aplicación.
    |
    */
    ...
    */
    ...
    'attributes' => [
        ...
        'eps' => 'EPS',
        'ips_preferida' => 'IPS preferida',
        'role_assigned' => 'rol asignado',
        'user_id' => 'usuario',
        'specialty' => 'especialidad',
        'appointment_type' => 'tipo de cita',
        'appointment_date' => 'fecha de la cita',
        'need_reason' => 'motivo de la necesidad',
        'need_urgency' => 'urgencia',
        'status' => 'estado',
        'diagnosis' => 'diagnóstico',
        'cancelled_reason' => 'motivo de cancelación',
        'cancelled_by' => 'cancelado por',
        'recurrence_type' => 'frecuencia de recurrencia',
        'dosage' => 'dosis',
        ...
        'denied_reason' => 'motivo de negación',
