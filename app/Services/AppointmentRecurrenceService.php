...
class AppointmentRecurrenceService
{
    ...
    public function generateNext(Appointment $appointment): Appointment
    {
        ...
        $siguienteCita = Appointment::create([
            ...
            'max_days_to_schedule' => $appointment->max_days_to_schedule ?? 30,
            'alert_days_before_scheduling' => $appointment->alert_days_before_scheduling ?? 10,
            ...
            'alert_days_before_appointment' => $appointment->alert_days_before_appointment ?? 3,
